...
import { EmployerContex } from "../../../Contex/EmployerContex";

export default function TeacherTable() {
  const { EmployerUsers, Loading, fetchEmployerData } =
    useContext(EmployerContex); // fetch data from teachercontext
